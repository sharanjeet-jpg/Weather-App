...
fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=Shanghai', options)
        ...
        fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=Korea', options)
        .then(response => response.json())
        .then((response) => {
        ...
        fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=USA', options)
        .then(response => response.json())
        .then((response) => {
